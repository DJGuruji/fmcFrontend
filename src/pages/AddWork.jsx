...
const AddWork = () => {
  ...
  return (
    <div className="bg-slate-300 dark:bg-slate-900 h-screen flex justify-center items-center ">
      <div className=" bg-slate-200 dark:bg-slate-800 rounded-md shadow-lg  p-5 w-3/4 md:w-1/2 lg:w-1/2 xl:w-1/2  h-1/2">
        <p className=" text-center text-xl dark:text-white">
          Add your work so that every one can see your work
        </p>
